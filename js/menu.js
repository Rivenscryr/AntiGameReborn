...
AGO.Menu = {
    ...
    Hide: function (a) {
        ...
        AGO.Menu.status = 2;
        if (AGO.App.page === "messages" || !AGO.App.isVersion7)
            DOM.setStyleDisplayChildren("contentWrapper", "id", "block");
        else
            DOM.setStyleDisplayChildren("middle", "id", "block");
    },
    Save: function () {
...
AGO.Menu.Show = function (a) {
    ...
    var t, m;
    if (t = document.getElementById(AGO.App.page === "messages" || !AGO.App.isVersion7 ? "contentWrapper" : "middle")) {
        ...
        ), l("U19", "", "CA5", 2), d("U22"), AGO.Menu.appendSection("U30"), d("U31"), d("U32", "", "", 2), d("U33", "", "", 2), d("U35", "", "", 2), d("U34"), d("U41"), g("U51", "", [
                " - ",
                "AI1",
                "AI2"
            ]
        ...
        ),d("I05"),AGO.Menu.appendSection("I80"),d("I81"),d("I82", "", "", 2),d("I83"),d("I85"),AGO.Menu.appendSection("O50"),d("O51"),d("O53"),d("O52"),d("O54"),d("O55"), /* AGO.Menu.appendSection("O60"),d("O61"), */ AGO.Menu.appendSection("O70"), g("O71", "", ["O72", "O73"]), AGO.Menu.appendTab("Buildings"),AGO.Menu.appendSection("A80"),d("B01"),d("B02"),d("B31"),g("B35", "", [
                "L091",
                "L092",
                "L093"
            ], 2
        ...
        ),d("B04"),d("B20"),d("B05"),AGO.Menu.appendTab("Fleet"),AGO.Menu.appendSection("F00", "A80"),d("F01"),
        d("F03"),g("F02", "", [
                " - ",
                "B22",
                "B23",
        ...
        ),g("FA2", "", (AGO.Uni.probeCargo > 0) ? {0: "L203", 1: "L202", 2: "L210", 3: "L219"} : {0: "L203", 1: "L202", 3: "L219"}),g("FA1", "", {0: " - ", 1: "L081", 3: "L083"}),g("FA3", "", {
                0: " - ",
                2: "2 %",
                4: "4 %",
                7: "7 %",
        ...
        ),d("M16"),d("M14"),d("M20"),/*d("M28", "", "", 2),*/d("M30"),d("M36", "", "", 2),d("M37", "", "", 2),d("M38"), AGO.App.page === "messages" || !AGO.App.isVersion7 ? DOM.setStyleDisplayChildren("#contentWrapper") : DOM.setStyleDisplayChildren("#middle"),(m = t.querySelector("#ago_menu")
