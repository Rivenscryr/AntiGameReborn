...
AGO.App = {
    ...
    Start: function () {
        ...
        document.location.href.match(/http:\/\/.+\.ogame.gameforge.com\/game\/index\.php\?+.*page=*/i) ? (AGO.App.page = STR.getParameter("page", document.location.href).toLowerCase(), AGO.App.page = 0 === AGO.App.page.indexOf("fleet") && STR.getParameter("cp", document.location.href) ? "fleet1" : AGO.App.page, AGO.Uni.path = document.location.href.split("?")[0] +
                                                                                                                                                                                                                                                                                                                                        "?page=", b = (a[0] || ""
